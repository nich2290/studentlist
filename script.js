    ...
    if (filter == "alle" || filter == student.house) {
      ...
      dest.lastElementChild.addEventListener("click", () => {
        ...
        function visSingle(student) {
          //This function shows the selected student in a popup window and needs abit more work design wise. The functionality is there, but the UX needs tweaks.
...
function popUpColors() {
  //colors of houses
  // This function is supposed to display different colors based on the house that is chosen, and is executed with an IF statement.
  ...
  if (studentHouse == "Gryffindor") {
    ...
    document.querySelector("h2").style.color = teksten;
    document.querySelector("p").style.color = teksten;
...
function clickSorting() {
  // This function is used to sort the context by either First name, last name or house and it works in the console so far. I need to work further on it and figure how i implement it in live.
...
function clickFilter() {
  // This function filters the content bases on which house they are in.
